...
const KPICard = ({ icon, label, value, subtitle }: KPICardProps) => {
    return (
        <div className='bg-slate-800 rounded-lg p-3 md:p6 flex flex-col items-center justify-center text-center'>
    ...
    return (
        <div className='w-full'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 m-4'>
                <KPICard
                    icon={<Flame className='stroke-orange-500 fill-orange-400 size-6 md:size-8' />}
                ...
                <KPICard
                    icon={<Crown className='stroke-yellow-400 fill-yellow-400 size-6 md:size-8' />}
                ...
                <KPICard
                    icon={<CheckCircle2 className='stroke-green-400 size-6 md:size-8' />}
                ...
                <KPICard
                    icon={<CalendarCheck2 className='stroke-indigo-400 size-6 md:size-8' />}
