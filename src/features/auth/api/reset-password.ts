import { AuthenticationService, type MessageResponse, type ResetPasswordRequest } from '@/api';
 ...
 */
export const ResetPassword = async (request: ResetPasswordRequest): Promise<MessageResponse> => {
