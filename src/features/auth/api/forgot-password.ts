import { AuthenticationService, type ForgotPasswordRequest, type MessageResponse } from '@/api';
 ...
 */
export const ForgotPassword = async (request: ForgotPasswordRequest): Promise<MessageResponse> => {
